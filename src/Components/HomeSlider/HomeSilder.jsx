...
export default function HomeSlider() {
  ...
  <section className="py-8 px-4 md:px-8">
    <div className="container mx-auto">
      <div className="flex flex-col md:flex-row gap-4 md:gap-6 h-auto md:h-[500px]">
                ...
                <div key={index} className="relative">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4 sm:p-6">
                    <div className="max-w-md">
                      <h3 className="text-lg sm:text-xl md:text-3xl font-bold text-white mb-2">
                      ...
                      <button className="mt-3 sm:mt-4 px-4 sm:px-6 py-2 bg-white text-green-600 font-medium rounded-full hover:bg-green-100 transition-all duration-300">
                        Shop Now
                      </button>
                    </div>
                  </div>
        ...
        <div className="w-full md:w-1/3 flex flex-col gap-4 md:gap-6 mt-4 md:mt-0">
          <div className="relative rounded-xl overflow-hidden shadow-lg aspect-[4/3] md:aspect-auto md:h-[48%] group">
            <img 
              src={slider4} 
              alt="side-banner-1" 
            ...
            <div className="absolute inset-0 bg-black/20 flex items-end p-4 sm:p-6">
              <div>
                <h3 className="text-lg sm:text-xl font-bold text-white mb-1">Skincare Essentials</h3>
          ...
          <div className="relative rounded-xl overflow-hidden shadow-lg aspect-[4/3] md:aspect-auto md:h-[48%] group">
            ...
            <div className="absolute inset-0 bg-black/20 flex items-end p-4 sm:p-6">
              <div>
                <h3 className="text-lg sm:text-xl font-bold text-white mb-1">Makeup Tools</h3>
