...
const WishList = () => {
  ...
  return (
    <section className="py-10 px-4 bg-gray-50 min-h-screen">
      ...
      >
        <h1 className="text-3xl font-bold text-green-600">Your Wishlist</h1>
                ...
                <div className="p-5 flex flex-col flex-grow gap-3">
                  ...
                  <div className="mt-auto flex justify-between gap-2 pt-4">
                    <button
                      ...
                      className="w-full sm:w-[40%]  bg-red-100 text-red-700 hover:bg-red-200 font-medium py-2 rounded-lg transition-colors"
                    >
                      <i className="fa fa-trash mr-2"></i> Remove
                    </button>
                    <button
                      onClick={() => addProduct(item._id)}
                      className="w-full sm:w-[60%] bg-green-100 text-green-700 hover:bg-green-200 font-medium py-2 rounded-lg transition-colors"
                    >
